...
import eatifylogo from "../assets/eatifylogo.png"
 const Header=({setfilterdata ,alldata})=>{
   const[searchText ,setSearchText] =useState("");

     function filterdatahandler(){
       const data =alldata.filter((restaurant)=>restaurant.info.name.toLowerCase().includes(searchText.toLowerCase()));
       setfilterdata(data);  
     }
    return (
        ...
        <div className="relative mb-4 flex  flex-wrap items-stretch">
            <input onKeyDown={(e)=>e.key==='Enter'?filterdatahandler():{}}
                type="search"
